...
@click.option('--encoder-save-path', '-encoder', type=str, default='models/feature_encoder_pretrained_1_way_5shot.pkl')
@click.option('--network-save-path', '-network', type=str, default='models/relation_network_pretrained_1_way_5shot.pkl')
